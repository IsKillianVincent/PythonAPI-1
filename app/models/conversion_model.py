...
class ConvertQueryParams(BaseModel):
    ...
    from_currency: constr(strict=True, min_length=1, max_length=5) = Field(..., description="Devise source (ISO 4217)")
    to_currency: constr(strict=True, min_length=1, max_length=5) = Field(..., description="Devise cible (ISO 4217)")
